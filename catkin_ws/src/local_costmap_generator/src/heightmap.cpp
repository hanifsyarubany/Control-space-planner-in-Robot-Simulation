                                    ...
                                    size_t &empty_count)
{
  ...
  for (unsigned i = 0; i < npoints; ++i) {
    ...
    double local_y = (-1)*scan->points[i].x; // currently, wrong transform. you need to fix this!
    double local_z = (-1)*scan->points[i].y; // currently, wrong transform. you need to fix this!
